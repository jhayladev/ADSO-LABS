// RNF-03 — escenario "dashboard": GET /api/mi-dashboard con 50 VUs sostenidos.
// Endpoint SELF: el idUsuario se deriva del token, no se manda por query string.
...
export default function () {
  ...
  const res = http.get(`${API_BASE_URL}/api/mi-dashboard`, {
